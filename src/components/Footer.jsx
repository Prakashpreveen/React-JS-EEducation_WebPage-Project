        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <p className="text-dark2">
              ...
              sint a facere placeat voluptatibus impedit deleniti veniam
              voluptatem? Beatae qui vero cumque eum corrupti ratione
              praesentium nobis minima totam fuga?
            </p>
          </div>
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <div className="flex items-center">
              ...
              />
              <button className="primary-btn font-semibold py-4 px-6 rounded-e-xl">
                Go
              </button>
            </div>
            {/* Social Icons */}
            <div className="flex space-x-6 py-3">
              ...
              <a href="#">
                <TbWorldWww className="cursor-pointer hover:text-primary hover:scale-110 duration-200" />
              </a>
              <a href="#">
